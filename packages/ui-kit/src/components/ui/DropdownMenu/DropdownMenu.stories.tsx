    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56">
        ...
        <DropdownMenuSub>
          ...
          <DropdownMenuPortal>
            <DropdownMenuSubContent>
              <DropdownMenuItem>project-1.txt</DropdownMenuItem>
              <DropdownMenuItem>project-2.txt</DropdownMenuItem>
              <DropdownMenuItem>project-3.txt</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem>More files...</DropdownMenuItem>
            </DropdownMenuSubContent>
          </DropdownMenuPortal>
        </DropdownMenuSub>
        <DropdownMenuSeparator />
