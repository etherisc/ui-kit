...
export function LoginForm() {
  ...
  return (
    <Form form={form} onSubmit={handleSubmit} className="space-y-4">
      ...
      />
      <button type="submit" className="px-4 py-2 rounded-md text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90">
        Sign In
      </button>
    </Form>
  );
...
<FormGroup 
  ...
  required
>
  <input type="email" id="email" className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" />
</FormGroup>
```
