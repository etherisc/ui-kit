...
function TestComponent() {
  ...
  return (
    <div>
      ...
      <button
        onClick={() =>
          addToast({ title: "Test Toast", variant: "success", duration: 100 })
        }
...
describe("ToastProvider", () => {
  ...
  it("should add a toast when addToast is called", () => {
    ...
    // Look for the actual toast element specifically (not toast-count)
    const toastElements = screen
      .getAllByTestId(/^toast-/)
      .filter((el) => el.getAttribute("data-testid") !== "toast-count");
  ...
  it("should remove a toast when removeToast is called", () => {
    ...
    // Find the toast in the test component and remove it
    const toastElements = screen
      .getAllByTestId(/^toast-/)
      .filter((el) => el.getAttribute("data-testid") !== "toast-count");
