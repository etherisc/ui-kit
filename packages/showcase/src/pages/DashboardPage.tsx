        ...
        >
            <div className="space-y-4">
                ...
                <div className="mb-6">
                    ...
                    <p className="text-sm font-medium text-gray">Welcome back! Here's what's happening with your business today.</p>
                </div>
                        ...
                        <div className="flex h-full grow flex-col">
                            <div className="flex grow flex-col gap-5 p-6 sm:flex-row sm:justify-between">
                                ...
                                <div className="m-auto grow flex items-center justify-center">
                                    <div className="text-center text-gray-500">
                                        <BarChartIcon size={48} className="mx-auto mb-2 opacity-50" />
                            ...
                            <div className="grid grid-cols-2 divide-x divide-y divide-gray-300 border-t border-gray-300 sm:grid-cols-4 sm:divide-y-0">
                                {stats.map((stat, index) => (
                                    <div key={stat.label} className={`space-y-4 px-4 py-6 sm:px-[18px] sm:py-6 ${index === 1 ? 'bg-gradient-to-b from-success/5 to-success/0' : ''}`}>
                                        ...
                                        <div className="space-y-2">
                                            <p className="text-xs font-medium text-gray">{stat.label}</p>
                            ...
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray">Latest updates and notifications</p>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-start gap-4 p-4 bg-success-light rounded-lg">
                                        ...
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-black">New customer registration</p>
                                            <p className="text-xs text-gray mt-1">John Smith joined the platform</p>
                                            <span className="text-xs text-gray-500 mt-2 inline-block">2h ago</span>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-4 bg-light-blue rounded-lg">
                                        <div className="w-2 h-2 bg-primary rounded-full mt-2 flex-shrink-0"></div>
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-black">Policy renewal processed</p>
                                            <p className="text-xs text-gray mt-1">Auto insurance policy #AI-2024-001</p>
                                            <span className="text-xs text-gray-500 mt-2 inline-block">4h ago</span>
                                        </div>
                                    </div>
                                    <div className="flex items-start gap-4 p-4 bg-light-orange rounded-lg">
                                        <div className="w-2 h-2 bg-warning rounded-full mt-2 flex-shrink-0"></div>
                                        <div className="flex-1">
                                            <p className="text-sm font-medium text-black">Claim requires attention</p>
                                            <p className="text-xs text-gray mt-1">Vehicle damage claim #VD-2024-089</p>
                                            <span className="text-xs text-gray-500 mt-2 inline-block">6h ago</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6">
                                <div className="flex items-center justify-between mb-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray">Frequently used operations</p>
                                    </div>
                                    <button className="text-gray-400 hover:text-gray-600">
                                        <Ellipsis className="size-5" />
                                    </button>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        ...
                                        <div className="text-center">
                                            <p className="text-sm font-medium text-black">View Customers</p>
                                    ...
                                    <button className="flex flex-col items-center gap-3 p-4 bg-light-theme rounded-lg hover:bg-primary/10 transition-colors group">
                                        ...
                                        <div className="text-center">
                                            <p className="text-sm font-medium text-black">New Policy</p>
                                            <p className="text-xs text-gray">Create insurance policy</p>
                                        </div>
                                    </button>
                                    <button className="flex flex-col items-center gap-3 p-4 bg-light-theme rounded-lg hover:bg-primary/10 transition-colors group">
                                        <div className="p-3 bg-primary/10 rounded-lg group-hover:bg-primary/20 transition-colors">
